...
E.g., let $\mathbf{H}_{\text{shot}} \in \mathbb{R}^{4 \times l}, \mathbf{H}_{\text{cross}} \in \mathbb{R}^{8 \times l}$ be compressed heatmaps for the events shot and cross with components 4 and 8. The 4 + 8 = 12 dimensional player vector of the i-th player would be 
